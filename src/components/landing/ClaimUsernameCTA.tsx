  ...
  return (
    ...
    `}>
      <form 
        ...
        `}
      >
        <div className="flex flex-1 items-center pl-3.5 sm:pl-4 pr-2 sm:pr-2 py-3">
        ...
        <div className="p-1.5 sm:p-1.5 pr-2 sm:pr-2">
          <button
            type="submit" 
            className="bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 text-white font-medium text-xs sm:text-sm py-2 px-2 sm:px-5 rounded-lg sm:rounded-full transition-all duration-300"
          >
            <span className="block sm:hidden">Claim</span>
            <span className="hidden sm:block whitespace-nowrap">Claim Username</span>
          </button>
        </div>
      </form>
    </div>
