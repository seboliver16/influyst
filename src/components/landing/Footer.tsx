      ...
      <div className="container mx-auto py-16 px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-500 hover:text-purple-600 transition-colors" aria-label="Twitter">
                <Twitter size={20} />
              </a>
              <a href="#" className="text-gray-500 hover:text-purple-600 transition-colors" aria-label="Instagram">
                <Instagram size={20} />
              </a>
              <a href="#" className="text-gray-500 hover:text-purple-600 transition-colors" aria-label="LinkedIn">
                <Linkedin size={20} />
              </a>
              <a href="#" className="text-gray-500 hover:text-purple-600 transition-colors" aria-label="YouTube">
                <Youtube size={20} />
              </a>
            </div>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/brands" className="text-gray-600 hover:text-purple-600 transition-colors">
                  For Brands
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="mailto:influyst@gmail.com" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">
              influyst@gmail.com
            </a>
          </div>
        </div>
